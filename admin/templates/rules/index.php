...
<div class="wrap">
    ...
    <table class="wp-list-table widefat fixed striped">
        ...
        <tbody>
            <?php if (!empty($rules)) : ?>
                <?php foreach ($rules as $rule) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=dcw-edit-rule&rule_id=' . $rule->id)); ?>" class="button button-small">Edit</a>
            ...
            <?php else : ?>
                <tr>
                    <td colspan="4" style="text-align:center;">No discount rules found. <a href="<?php echo esc_url(admin_url('admin.php?page=dcw-add-rule')); ?>">Add New Rule</a></td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
